...
const COOKIE_NAME = "vandb_access";
const PASSWORD = "VANDB2026";
...
export default function PasswordGate({ children }: { children: ReactNode }) {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    if (input.trim() === PASSWORD) {
      setCookie(COOKIE_NAME, "granted", 86400, "/vandb");
      setUnlocked(true);
    } else {
      setError(true);
      ...
      {unlocked ? (
        ...
        >
          ...
          >
            ...
            >
              Cette page est reservee au reseau{" "}
              <span className="text-text font-semibold">V&amp;B</span> (Vins &amp; Bieres) et Levrette Cafe.
              <br />
