...
const SIGNUP_VANDB = `${URLS.signup}?coupon=VANDB`;
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 w-full">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              Blind test musical, quiz, Petit Bac, jeux d&apos;arcade... Vos clients
              scannent un QR code et jouent depuis leur telephone. Cle en main,
...
const VALUE_PROPS = [
  {
    icon: Film,
    title: "Diversifiez vos animations en bar",
    desc: "Proposez une experience interactive qui attire une clientele variee : afterworks recurrents, soirees degustation, blind tests thematiques.",
    color: "text-primary",
    bg: "bg-primary/10",
  },
  {
    ...
    desc: "Activez votre bar entre les afterworks et lors des soirees creuses. Transformez les temps morts en moment de jeu collectif et de drive-to-store.",
    color: "text-accent",
    bg: "bg-accent/10",
  },
  {
    ...
    desc: "Aucun materiel supplementaire. Une TV, un navigateur, c'est pret. Vos clients jouent depuis leur telephone via QR code.",
    color: "text-success",
    bg: "bg-success/10",
  },
];

function VandbValueProp() {
  return (
      ...
      <div className="relative max-w-5xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Pourquoi Unboared pour votre V&amp;B ?
          </h2>
...
const FEATURES = [
  ...
  },
  {
    ...
    desc: "Des quiz sur tous les themes : culture generale, sport, vins et spiritueux, musique. Creez vos propres quiz personnalises.",
    color: "text-primary",
    bg: "bg-primary/10",
    badge: null,
  },
  ...
  },
  {
    ...
    desc: "Toute la salle peut jouer en meme temps. Chaque client participe depuis son smartphone.",
    color: "text-primary",
    bg: "bg-primary/10",
    badge: null,
  },
...
function VandbHowItWorks() {
  const steps = [
    ...
    { icon: Trophy, title: "Jouez !", desc: "Vos clients scannent le QR code et jouent depuis leur telephone. C'est parti !" },
  ];
  ...
  return (
    <section className="py-32 px-6 relative overflow-hidden border-t border-border">
      ...
      >
        ...
        >
          Rejoignez le reseau V&amp;B sur Unboared. Essai gratuit, sans
          engagement.
        </motion.p>
...
export default function VandbLanding() {
  return (
    <PasswordGate>
      <MinimalHeader />
